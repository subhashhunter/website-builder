...
const MyProjects = () => {
  ...
  const deleteProject=async(projectId:string)=>{
    try {
      const confirm=window.confirm('Are you sure that you want to delete this project')
      if(!confirm) return
 ...
 const navigate=useNavigate()
  ...
  return (
    <>
    <div className='px-4 md:px-16 lg:px-16 xl:px-32'>
      {loading ?(
       ...
       <div className='py-10 min-h-[8-vh]'>
            ...
            transition-all duration-300'>
              ...
              overflow-hidden border-b border-gray-800'>
                {project.current_code?(
                  <iframe srcDoc={project.current_code} className='absolute top-0 w-300 h-[800px] origin-top-left pointer-events-none 
              ...
              from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                ...
                <div onClick={(e)=>e.stopPropagation()}
                  ...
                  <div className='flex gap-3 text-white text-sm '>
                    ...
                    hover:bg-white/15 rounded-md transition-colors'>Open</button>
                  </div>
                </div>
              </div>
              <div onClick={(e)=>e.stopPropagation()}>
        ...
        <div className='flex flex-col items-center justify-center h-[80vh]'>
          <h1 className='text-3xl font-semibold text-gray-300'>
            You have not any projects yet!
          </h1>
          <button onClick={()=>navigate('/')} className='text-white px-5 py-2 mt-5 
